...
public class ReLogoPatch extends BasePatch{
	...
	/**
	 * Sprouts (makes) a number of new clusterNodes and then executes a set of commands on the
	...
	public AgentSet<net2.relogo.ClusterNode> sproutClusterNodes(int number, Closure closure) {
		AgentSet<net2.relogo.ClusterNode> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.sprout(number,closure,"ClusterNode");
	 ...
	 */
	@ReLogoBuilderGeneratedFor("net2.relogo.ClusterNode")
	public AgentSet<net2.relogo.ClusterNode> sproutClusterNodes(int number) {
		return sproutClusterNodes(number,null);
	}
	...
	/**
	 * Sprouts (makes) a number of new messageInforms and then executes a set of commands on the
	...
	public AgentSet<net2.relogo.MessageInform> sproutMessageInforms(int number, Closure closure) {
		AgentSet<net2.relogo.MessageInform> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.sprout(number,closure,"MessageInform");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("net2.relogo.MessageInform")
	public AgentSet<net2.relogo.MessageInform> sproutMessageInforms(int number) {
		return sproutMessageInforms(number,null);
	}
	...
	/**
	 * Sprouts (makes) a number of new packets and then executes a set of commands on the
	 * created packets.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<net2.relogo.Packet> sproutPackets(int number, Closure closure) {
		AgentSet<net2.relogo.Packet> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.sprout(number,closure,"Packet");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("net2.relogo.Packet")
	public AgentSet<net2.relogo.Packet> sproutPackets(int number) {
		return sproutPackets(number,null);
	}
	...
	public AgentSet<net2.relogo.UserTurtle> sproutUserTurtles(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("net2.relogo.UserTurtle")
	public AgentSet<net2.relogo.UserTurtle> sproutUserTurtles(int number) {
