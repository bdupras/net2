/*
 * Forked from Guava to provide ability to specify a custom Ticker.
 * 
...
abstract class ForkedSmoothRateLimiter extends ForkedRateLimiter {
   ...
   */
     ...
     */
    static final class SmoothWarmingUp extends ForkedSmoothRateLimiter {
    ...
    private ForkedSmoothRateLimiter(SleepingStopwatch stopwatch) {
        super(stopwatch);
    }
